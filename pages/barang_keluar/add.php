<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($item_name == '' || $qty == '' || $item_location == '') {
      ...
      $stmt = $pdo->prepare("INSERT INTO barang_keluar (nama_barang, qty, lokasi_barang, id_kategori, id_pemasok, id_pengguna) VALUES (:nama_barang, :qty, :lokasi_barang, :id_kategori, :id_pemasok, :id_pengguna)");
      $stmt->execute([
    ...
    echo "<script type='text/javascript'>alert('Barang keluar berhasil di input'); window.location.href='index.php';</script>";
  }
?>
<div class="content flex-column">
    <h2 class="mb-8">Tambah Barang Keluar</h2>
    <p class="small">Halaman untuk menambahkan data barang keluar</p>
